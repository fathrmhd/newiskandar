      ...
      <div className="mx-auto flex max-w-[1180px] items-center justify-between px-5 py-3 sm:px-8">
        ...
        >
          <img
            src={logo}
            alt="Twin Craft"
            className="h-full w-full object-contain scale-440"
          />
        </button>
  ...
  return (
    <footer className="border-t border-white/10 bg-navy px-5 py-8 text-center sm:px-8 mt-12">
      <div className="flex justify-center">
        <div className="flex h-16 w-56 items-center justify-center overflow-hidden">
          <img
            src={logo}
            alt="Twin Craft"
            className="h-full w-full object-contain scale-400"
          />
        </div>
      </div>
      <Canting className="mx-auto mt-4 h-2 w-40 text-ocean" />
      <p className="mt-3 text-[13px] text-sky/60">
        Twin Craft · AI for the Backbone of the Economy
      </p>
      <p className="mt-1 text-xs text-sky/40">
        MVP — AI Innovation Challenge COMPFEST 18
      </p>
    </footer>
  );
}
